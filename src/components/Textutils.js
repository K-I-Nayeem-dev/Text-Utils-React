                ...
                <div className="col-lg-10">
                    <div className="form-floating mb-3">
                        <div className="mb-3">
                            ...
                            <textarea className="form-control my-3"  onChange={handleOnChange} value={text} id="exampleFormControlTextarea1" rows="8"></textarea>
                            ...
                            <p style={{ ...colorr }} className='my-2'>{text.split(/\s+/).filter((element)=>{return element.length !== 0}).length} Words {text.length} TextUtils character</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="container">
            <div className="row d-flex justify-content-center my-3">
                <div className="col-lg-10">
                    <div className="form-floating mb-3">
                        <div className="mb-3">
                            <h1 style={{ ...colorr }}>Your Preview Here</h1>
